            ...
            <div key={key} className="flex flex-col mb-4">
              ...
              {cardSettings[key as CardSettingKeys].map((description, index) => (
                <div key={index} className="flex items-center mb-2">
                  ...
                  <button onClick={() => startEditing(key as CardSettingKeys, index)} className="text-blue-500 mr-2">
                    Edit
                  </button>
              ...
              <input
                ...
                onChange={(e) =>
                  setNewDescriptions((prev) => ({ ...prev, [key as CardSettingKeys]: e.target.value }))
                }
                className="border rounded p-2 mb-2"
                placeholder="Add a description"
              />
              {currentEditing?.key === key && currentEditing.index !== undefined ? (
                <button
